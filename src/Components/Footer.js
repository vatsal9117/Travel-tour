const Footer = () => {
    return (  
        <div className="footer-wrapper  container-fluid mt-5">
                    ...
                    <div className="col-lg-3 col-sm-12 col-md-6 about-us">
                         ...
                         <div className="row">
                            <ul>
                                ...
                                <a href="#"><li>Travel Blog & Tips</li></a>
                                <a href="#"><li>Working With Us</li></a>
                                <a href="#"><li>Be Our Partner</li></a>
                             </ul>
                        </div>
                    </div>
                    <div className="col-lg-3  col-md-6 col-sm-12 about-us">
                            ...
                            <div className="row">
                                <ul>
                                    ...
                                    <a href="#"><li>Contact Channels</li></a>
                                </ul>
                            </div>
                    </div>
                    <div className="col-lg-3  col-md-6 col-sm-12 about-us">
