        ...
        <div className="container-fluid news-letter">
              <div className="row container-fluid">
                ...
                <div className=" newsletter col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div className="row mt-3 subscription">
                        ...
                        <div className="row mt-3">
                            <div className="col-lg-6 newsform">
                                 <input type="" name="" value="Your Email Address"></input>
                            </div>
                            <div className="col-lg-6 newsform ">
                    ...
                    <div className="row mt-3 icons">
                        <div className="col icons-i">
                            <i class="bi bi-facebook"></i>
                            <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pinterest" viewBox="0 0 16 16">
