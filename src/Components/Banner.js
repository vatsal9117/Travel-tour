        ...
        <div  className="banner">
            <div className="container">
                <div className="banner-content text-center text-white">
                    <h1 className="fw-bold"><big>Find Next Place To Visit</big></h1>
                ...
                <div  className="form-outer">
                    <form>
                        <div className="row mt-5">
                            ...
                            <div className="form-fields second-wrap col-lg-3 col-md-4 col-sm-12">
                                        <select data-trigger="" name="choices-single-defaul">
                                            <option placeholder="">Destinations</option>
                            ...
                            <div className="form-fields third-wrap col-lg-3 col-md-4 col-sm-12 ">
                                        <select data-trigger="" name="choices-single-defaul">
                        ...
                        <div className="row">
                            ...
                            <div className="destination-content col-lg-9 col-md-10 col-sm-10">
                                <div>
                                    ...
                                    <h5>Our expert team handpicked all destinations in this site</h5>
                                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="destination-content col-lg-9 col-md-10 col-sm-10">
                                <div>
                                    ...
                                    <h5>We are here to help, before, during, and even after your trip.</h5>
                                </div>
