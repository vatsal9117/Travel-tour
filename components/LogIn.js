    ...
    oldArr.map(arr => 
      {
        if(this.state.name.length > 0 && this.state.password.length > 0){
          if (arr.username === this.state.name && (arr.password === this.state.password)) {
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 form-field">
                            ...
                            <input type="text" className="username" name='username'  value={this.state.name} onChange={this.onChangeName } required/>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-12 form-field">
                            <label>Password</label>
                            <input type="password" name='password' className="password" value={this.state.password} onChange={this.onChangePassword} required autoComplete='off'/>
                        </div>
                    </div>
                    <div className="row">
                    <input type="submit" className="signin"  value="Sign In!" onClick={this.props.onLogin} />
